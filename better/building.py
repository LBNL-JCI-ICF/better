...
class Building:
    ...
    def benchmark(self, use_default=True, df_benchmark_stats_electricity=None,
        ...
        self.benchmarking_bar_ccp_e_html = Benchmark.generate_benchmark_bar_html(self.benchmark_CCP_e)
        self.benchmarking_bar_csl_e_html = Benchmark.generate_benchmark_bar_html(self.benchmark_CSL_e)

        self.benchmarking_bar_hsl_f_html = Benchmark.generate_benchmark_bar_html(self.benchmark_HSL_f)
        self.benchmarking_bar_hcp_f_html = Benchmark.generate_benchmark_bar_html(self.benchmark_HCP_f)
        self.benchmarking_bar_base_f_html = Benchmark.generate_benchmark_bar_html(self.benchmark_BASE_f)
        self.benchmarking_bar_ccp_f_html = Benchmark.generate_benchmark_bar_html(self.benchmark_CCP_f)
        self.benchmarking_bar_csl_f_html = Benchmark.generate_benchmark_bar_html(self.benchmark_CSL_f)
